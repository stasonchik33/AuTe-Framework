...
var ProjectDetailComponent = (function () {
    ...
    ProjectDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap
            ...
            _this.project = value;
            _this.selectedEnvironmentId = parseInt(localStorage.getItem(__WEBPACK_IMPORTED_MODULE_5__scenario_list_item_scenario_list_item_component__["b" /* PROJECT_ENV_TOKEN */] + _this.project.id), 10);
        });
        this.route.paramMap
    ...
    ProjectDetailComponent.prototype.changeEnv = function () {
        localStorage.setItem(__WEBPACK_IMPORTED_MODULE_5__scenario_list_item_scenario_list_item_component__["b" /* PROJECT_ENV_TOKEN */] + this.project.id, String(this.selectedEnvironmentId));
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return PROJECT_ENV_TOKEN; });
...
var PROJECT_ENV_TOKEN = 'bsc_autotester_project_env';
var ScenarioListItemComponent = (function () {
    ...
    ScenarioListItemComponent.prototype.runScenario = function () {
        ...
        if (this.state !== 'executing') {
            ...
            this.state = 'starting';
            this.stateChanged();
            var projectEnvironmentId = parseInt(localStorage.getItem(PROJECT_ENV_TOKEN + this.projectId), 10);
...
var ScenarioService = (function () {
    ...
    ScenarioService.prototype.run = function (scenario, executionEnvironmentId) {
        return this.http.post(this.globals.serviceBaseUrl + this.serviceUrl + '/start', {
