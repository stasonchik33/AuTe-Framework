        ...
        this.route.params.subscribe(function (params) {
            _this.scenarioService
                ...
                _this.projectService
                    .findOne(_this.scenario.projectId)
